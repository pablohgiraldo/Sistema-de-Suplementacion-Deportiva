          ...
          <div className="grid grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="text-sm space-y-1">
                ...
                <a href="/careers" className="block hover:text-blue-400 transition-colors cursor-pointer">Carreras</a>
                <a href="/legal-notice" className="block hover:text-blue-400 transition-colors cursor-pointer">Aviso Legal</a>
                <a href="/privacy-policy" className="block hover:text-blue-400 transition-colors cursor-pointer">Política de Privacidad</a>
                <a href="/terms-of-service" className="block hover:text-blue-400 transition-colors cursor-pointer">Términos de Servicio</a>
                <a href="/cookie-policy" className="block hover:text-blue-400 transition-colors cursor-pointer">Política de Cookies</a>
              </div>
            </div>
          </div>
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-4">
                ...
                <a
                  ...
                  className="w-12 h-12 bg-gradient-to-br from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 rounded-full flex items-center justify-center text-white transition-all duration-300 cursor-pointer hover:scale-110 shadow-lg"
                  title="Instagram"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 bg-black hover:bg-gray-800 rounded-full flex items-center justify-center text-white transition-all duration-300 cursor-pointer hover:scale-110 shadow-lg"
                  title="TikTok"
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
