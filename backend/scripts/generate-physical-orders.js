// Script para generar órdenes físicas en producción
...
const generatePhysicalOrders = async () => {
    try {
        console.log('✅ MongoDB de producción conectado');
        console.log('🏪 Generando órdenes físicas para producción...\n');
