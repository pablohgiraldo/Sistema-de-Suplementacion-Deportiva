// Script para activar productos y generar órdenes físicas
...
const activateProductsAndGenerateOrders = async () => {
    try {
        console.log('✅ MongoDB de producción conectado');
        console.log('🔄 Activando productos y generando órdenes físicas...\n');
...
// Ejecutar
activateProductsAndGenerateOrders();
